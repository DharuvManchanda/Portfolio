    ...
    <div className="Hero" id="top">
      ...
      <div className="text">
        ...
        <div className={open ? "paraText open" : "paraText close"}>
          <p>
            I am a passionate full-stack web developer with a strong enthusiasm
            for learning and exploring new technologies. I have successfully
            crafted numerous projects that showcase my expertise in the field.
          </p>

          <br />
          <p style={{ letterSpacing: 0.5, wordSpacing: "2px" }}>
            I am excited to continue my journey, embracing new challenges and
            refining my abilities as I strive for excellence in the
            ever-evolving world of web development:
            <span style={{ color: "#ed8936", fontWeight: "700" }}>
              {" "}
              JavaScript,{" "}
            </span>
          ...
          <br />
          <p>
            Want to Connect? Schedule
            <Link to="mailto:dharuvmanchanda@gmail.com" className="linkColor">
              {" "}
              Email me{" "}
            </Link>
            or
            <Link
              to="https://calendly.com/dharuvmanchanda001"
              className="linkColor"
            >
              {" "}
              Sign up{" "}
        ...
        <div className="icons">
          <Link to="https://github.com/DharuvManchanda" target="_blank">
            <BsGithub className="fa-brands" />
          </Link>
          <Link to="https://www.linkedin.com/in/dharuv-manchanda-270326233/" target="_blank">
            <FaLinkedin className="fa-brands" />
          </Link>
          <Link to="https://twitter.com/manchanda00" target="_blank">
            <FaTwitter className="fa-brands" />
          </Link>
          <Link to="https://www.instagram.com/dharuv_manchanda003/" target="_blank">
